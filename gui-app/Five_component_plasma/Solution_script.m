...
if app.Norm_flag.Value == 0
    en=1;
    pn = 1;
    lmd=1;
    
    app.E_norm.Value = max(ph0(:,3));
    app.E_unit.Value  ="    "
       app.W_norm.Value = wE;
    app.W_unit.Value  =" "
       app.V_norm.Value = M;
...
elseif app.Norm_flag.Value==1
    %% Unormalization
            Th = app.Th_unNorm.Value;
            ni0=app.N0_unNorm.Value;
    ...
    app.E_norm.Value = E_unormalized;
    app.E_unit.Value  ="mV/m"
       app.W_norm.Value = w_unormalized;
    app.W_unit.Value  ="m"
       app.V_norm.Value = M_unormalized;
    app.V_unit.Value  ="Km/s"
%     set(handles.Et,'String',E_unormalized)
%     set(handles.Mt,'String',M_unormalized)
%     set(handles.wt,'String',w_unormalized)
end
